...
public class UserController {
	...
	public ModelAndView processUserForm(@Valid @ModelAttribute("userObj") User user, BindingResult br,
			@RequestParam("cust") int custcode, @RequestParam("user_role") String user_role,
...
//					userService.addUser(credential);
	...
	public ModelAndView deleteUser(@PathVariable String username, RedirectAttributes redirect) {
